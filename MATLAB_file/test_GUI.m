...
% Last Modified by GUIDE v2.5 19-Jul-2022 21:37:56
...
theta1 =num2str(get(handles.slider1,'Value'));
set(handles.theta_1,'String',theta1);
set_param('C4_A601C/Robot/Slider Gain','Gain',theta1);
%set(handles.edit7,'string',out.X)
...
set(handles.slider1,'Value',str2double(handles.theta_1.String));
theta1 =num2str(get(handles.slider1,'Value'))
set_param('C4_A601C/Robot/Slider Gain','Gain',theta1);
...
% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
theta2 =num2str(get(handles.slider2,'Value'));
set(handles.theta_2,'String',theta2);
set_param('C4_A601C/Robot/Slider Gain1','Gain',theta2);
...
% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
theta3 =num2str(get(handles.slider3,'Value'));
set(handles.theta_3,'String',theta3);
set_param('C4_A601C/Robot/Slider Gain2','Gain',theta3);
...
% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
theta4 =num2str(get(handles.slider4,'Value'));
set(handles.theta_4,'String',theta4);
set_param('C4_A601C/Robot/Slider Gain3','Gain',theta4);
...
% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
theta5 =num2str(get(handles.slider5,'Value'));
set(handles.theta_5,'String',theta5);
set_param('C4_A601C/Robot/Slider Gain4','Gain',theta5);
...
set(handles.slider2,'Value',str2double(handles.theta_2.String));
theta2 =num2str(get(handles.slider2,'Value'))
set_param('C4_A601C/Robot/Slider Gain1','Gain',theta2);
...
set(handles.slider3,'Value',str2double(handles.theta_3.String));
theta3 =num2str(get(handles.slider3,'Value'))
set_param('C4_A601C/Robot/Slider Gain2','Gain',theta3);
...
set(handles.slider4,'Value',str2double(handles.theta_4.String));
theta4 =num2str(get(handles.slider4,'Value'))
set_param('C4_A601C/Robot/Slider Gain3','Gain',theta4);
...
set(handles.slider5,'Value',str2double(handles.theta_5.String));
theta5 =num2str(get(handles.slider5,'Value'))
set_param('C4_A601C/Robot/Slider Gain4','Gain',theta5);
...
% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
theta6 =num2str(get(handles.slider6,'Value'));
set(handles.theta_6,'String',theta6);
set_param('C4_A601C/Robot/Slider Gain5','Gain',theta6);
...
set(handles.slider6,'Value',str2double(handles.theta_6.String));
theta6 =num2str(get(handles.slider6,'Value'))
set_param('C4_A601C/Robot/Slider Gain5','Gain',theta6);
